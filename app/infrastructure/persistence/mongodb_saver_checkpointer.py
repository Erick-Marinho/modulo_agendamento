...
class AsyncMongoDBSaver(MongoDBSaver):
    ...
    async def aput(self, config: Dict[str, Any], checkpoint: Checkpoint, metadata: Dict[str, Any], new_versions: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def aput_writes(self, config: Dict[str, Any], writes: Sequence[Any], task_id: str) -> None:
        """
        ...
        try:
            ...
            if hasattr(self, 'put_writes'):
                ...
                logger.debug("put_writes não encontrado na classe pai, usando implementação básica")
                pass
    ...
    async def alist(self, config: Dict[str, Any], *, filter: Optional[Dict[str, Any]] = None, before: Optional[Dict[str, Any]] = None, limit: Optional[int] = None) -> List[CheckpointTuple]:
        """
